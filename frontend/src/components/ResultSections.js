  ...
  const sections = [
    ...
    },
    {
      ...
      items: [
        ...
        "October board-exam takers cannot be assigned to consult, cath, or PCICU in October.",
        "First-year fellows (PGY-4) cannot be assigned to PCICU before December.",
    ...
    },
    {
      ...
      items: [
        ...
        "Board-exam fellows avoid consult, cath, and PCICU in October.",
        "First-year fellows avoid PCICU before December.",
